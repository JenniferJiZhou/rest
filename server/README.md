...
`content/rest-quests.json` and the Demo mail fixture. GitHub Actions builds
an immutable GHCR image for ClawCloud Run App Launchpad. See
`../docs/18_CLAWCLOUD_RUN_STAGING_DEPLOYMENT.md`. No cloud resource or
certificate is created by the checked-in files.
